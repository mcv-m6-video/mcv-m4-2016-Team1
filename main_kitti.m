...
sq_0_train_flow_noc{2} = imread('./data_stereo_flow/training/flow_noc/000157_10.png'); 

sq_0_m4_kitti_flow_noc{1} = imread('./results_kitti/LKflow_000045_10.png');
sq_0_m4_kitti_flow_noc{2} = imread('./results_kitti/LKflow_000157_10.png');
...
subplot(4,2,6);
imshow(sq_0_train_flow_noc{t+1});
title('train kitti flow')

subplot(4,2,7);
imshow(sq_0_m4_kitti_flow_noc{t});
title('m4 kitti flow')

subplot(4,2,8);
imshow(sq_0_m4_kitti_flow_noc{t+1});
title('m4 kitti flow')
