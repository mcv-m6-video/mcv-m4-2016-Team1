...
if doTask4
    ...
    for i = 1:length(alpha)
        for j = 1:length(ro)
            ...
            [forEstim_highway,t1_h,t2_h]= task4(seq_input_highway,alpha(i),ro(j));
            [forEstim_fall,t1_f,t2_f] = task4(seq_input_fall,alpha(i),ro(j));
            [forEstim_traffic,t1_t,t2_t]= task4(seq_input_traffic,alpha(i),ro(j));
